...
//     const unreadNotes = allNotifications.notes.filter(
//       (n) => n.a.r === expectedRoute && !n.r // n.r is 'read' status
//     );

//     if (unreadNotes.length > 0) {
//       console.log(
//         `Found ${unreadNotes.length} notification(s) with route "${expectedRoute}".`
//       );
//       return unreadNotes;
//     }
...
//     if (attempt < retries) {
//       console.log(
//         `[Retry ${attempt}/${retries}] Notification not found yet. Waiting ${delayMs}ms...`
//       );
//       await new Promise((resolve) => setTimeout(resolve, delayMs));
//     }
//   }
...
//   console.log(
//     `No notifications with route "${expectedRoute}" found after ${retries} retries.`
//   );
//   return [];
// }
...
// export async function findCredentials(client: SignifyClient): Promise<any[]> {
//   console.log("Finding all credentials for given client:");
//   try {
//     const matchingCredentials = await client?.credentials()?.list();
//     console.log(`Found ${matchingCredentials?.length} matching credentials.`);
//     return matchingCredentials;
//   } catch (error) {
//     console.error("Failed to find matching credentials:", error);
